#ifndef GPUFIT_POLY2_CUH_INCLUDED
#define GPUFIT_POLY2_CUH_INCLUDED

/* Description of the calculate_poly2 function
* ===================================================
* Added by Sebastian Hambura the 06/2020
*
* This function calculates the values of 2nd degree polynomial model functions
...
__device__ void calculate_poly2(
    ...
    std::size_t const user_info_size)
{
    ...
    // value
    value[point_index] = (a*x + b ) * x + c;

    // derivatives
    REAL * current_derivatives = derivative + point_index;
    current_derivatives[0 * n_points] = x*x;
